...
import { addQuestion, deleteQuestion, editQuestion } from '../../../../redux/features/form/formSlice'
          ...
          <div className='flex space-x-2 items-center'>
            ...
            <div className='flex items-center space-x-2 h-fit'>
              ...
              >
                ...
                />
                <div className="w-[2.25rem] h-[1.25rem] bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-purple-600"></div>
              </label>
            </div>
          </div>
        </div>
